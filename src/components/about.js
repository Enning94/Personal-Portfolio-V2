...
const About = () => (
  <section
    id="about"
    className="about-section text-white d-flex py-5
    ...
    <div className="aboutme d-flex align-items-start about-text w-50 pr-5">
      ...
      <div className="d-flex flex-column align-items-between">
        ...
        <p className="text-bold" data-aos="fade-left">
          ...
          {' '}
          <br />
          <span className="text-yellow"> DESIGN & DEVELOP </span>
          {' '}
          THE BEST
          WEBSITES AROUND
        </p>
      ...
      <div className="lets-connect" data-aos="zoom-out">
        <div className="d-flex align-items-end">
          ...
          <a href="https://drive.google.com/file/d/1auJRIuuwt9Uw8zLkOxcA54TelgVmndT1/view?usp=sharing" className="" type="submit">
            Download CV
            <svg stroke="#f3ca2f" fill="#f3ca2f" strokeWidth="0" viewBox="0 0 24 24" className="download-icon" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
